...
export function register_outfit_tools(server: McpServer, supabase: SupabaseClient) {
  ...
  server.tool(
    ...
    async () => {
      ...
      if (error) {
        return {
          content: [{ type: "text", text: `Error getting outfits: ${error.message}` }],
          isError: true
        };
      }
  ...
  server.tool(
    ...
    async ({ 
      ...
      if (error) {
        return {
          content: [{ type: "text", text: `Error inserting outfit: ${error.message}` }],
          isError: true
        };
      }
  ...
  server.tool(
    ...
    async ({ 
      ...
      if (error) {
        return {
          content: [{ type: "text", text: `Error updating outfit: ${error.message}` }],
          isError: true
        };
      }
  ...
  server.tool(
    ...
    async ({ id }) => {
      ...
      if (error) {
        return {
          content: [{ type: "text", text: `Error deleting outfit: ${error.message}` }],
          isError: true
        };
      }
